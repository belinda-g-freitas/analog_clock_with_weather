...
class HourHandShadow extends StatelessWidget {
  const HourHandShadow({Key? key, required this.unit, required DateTime now, required this.customTheme})
      : _now = now,
        super(key: key);
          ...
          child: Transform.translate(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Colors.transparent,
                boxShadow: [BoxShadow(color: customTheme.canvasColor, blurRadius: unit)],
              ),
            ),
          ),
        ),
