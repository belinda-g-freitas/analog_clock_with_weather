...
class ContainerHand extends Hand {
  ...
  const ContainerHand({required Color color, required double size, required double angleRadians, required this.child})
      : /* assert(size != null),
    ...
    return Center(
      child: SizedBox.expand(
        child: Transform.rotate(
          ...
          child: Transform.scale(scale: size, alignment: Alignment.center, child: Container(color: color, child: Center(child: child))),
        ),
      ),
    );
  }
